      ...
      <div class="modal-body">
        <form action="actualizar_reservacion.php" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
              ...
              <input type="text" class="form-control" name="phone" id="phone" placeholder="Ingrese el telefono de contacto">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="estatus" id="estatus" placeholder="Ingresa el estatus">
            </div>
            <div class="form-group">
